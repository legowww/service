package com.res.microservices.order;
...
public class OrderServerApi {
    ...
    public ResponseEntity<String> payment(@RequestHeader(name = "Bearer") String header) throws UnknownHostException {
        ...
        response += "Order Server [IP: " + InetAddress.getLocalHost().getHostAddress() + " Port: " + webServerApplicationContext.getWebServer().getPort() + "] 응답";
